...
class SBTi:
    ...
    def get_sbti_targets(self, companies: List[IDataProviderCompany]) -> List[IDataProviderCompany]:
        """
        ...
        for company in companies:
            targets = self.targets[self.targets[self.c.COL_COMPANY_ID] == company.company_id]
            if len(targets) > 1:
