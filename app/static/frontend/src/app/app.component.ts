...
export class AppComponent implements OnInit {
    ...
    availableScenarios: any[] = [{'checked': 'checked', 'label':'scenario_1', 'description': 'With current targets, rest of portfolio business as usual'}, {'checked': '', 'label':'scenario_2', 'description': 'Scenario 1: "What-if" - all companies without targets set 2 °C targets'}, {'checked': '', 'label':'scenario_3', 'description': 'Scenario 2: "What-if" - all companies with targets set well below 2 °C targets'}, {'checked': '', 'label':'scenario_4', 'description': 'Scenario 3a: "What-if" - the 10 highest contributors to the portfolio set 2 °C targets'}, {'checked': '', 'label':'scenario_5', 'description': 'Scenario 3b: "What-if" - the 10 highest contributors to the portfolio set well below 2 °C targets'}, {'checked': '', 'label':'scenario_6', 'description': 'Scenario 4a: "What-if" all engagement target companies set 2 °C targets'}, {'checked': '', 'label':'scenario_7', 'description': 'Scenario 4b: "What-if" all engagement target companies set well below 2 °C targets'}];
