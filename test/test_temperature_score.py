...
class TestTemperatureScore(unittest.TestCase):
    ...
    def test_portfolio_aggregations(self):
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 3.1209, places=4,
                               msg="Short WATS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 2.8393, places=4,
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 2.9023, places=4,
                               msg="Short TETS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 3.0908, places=4,
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 2.9009, places=4,
                               msg="Short MOTS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 3.0851, places=4,
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 2.9541, places=4,
                               msg="Short EOTS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 3.1125, places=4,
