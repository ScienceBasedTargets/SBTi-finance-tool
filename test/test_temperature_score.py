...
class TestTemperatureScore(unittest.TestCase):
    ...
    def test_portfolio_aggregations(self):
        ...
        self.assertAlmostEqual(aggregations.short.S1S2.all.score, 2.7863, places=4,
                               msg="Short WATS aggregation failed")
        self.assertAlmostEqual(aggregations.mid.S1S2.all.score, 2.8064, places=4,
        ...
        aggregations = self.temperature_score.aggregate_scores(scores)
        self.assertAlmostEqual(aggregations.short.S1S2.all.score, 2.8598, places=4,
                               msg="Short TETS aggregation failed")
        self.assertAlmostEqual(aggregations.mid.S1S2.all.score, 2.8760, places=4,
        ...
        aggregations = self.temperature_score.aggregate_scores(scores)
        self.assertAlmostEqual(aggregations.short.S1S2.all.score, 2.8765, places=4,
                               msg="Short MOTS aggregation failed")
        self.assertAlmostEqual(aggregations.mid.S1S2.all.score, 2.8665, places=4,
        ...
        aggregations = self.temperature_score.aggregate_scores(scores)
        self.assertAlmostEqual(aggregations.short.S1S2.all.score, 2.9316, places=4,
                               msg="Short EOTS aggregation failed")
        self.assertAlmostEqual(aggregations.mid.S1S2.all.score, 2.8771, places=4,
