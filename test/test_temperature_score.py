...
class TestTemperatureScore(unittest.TestCase):
    ...
    def test_portfolio_aggregations(self):
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 3.035672847775627, places=4, msg="Short WATS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 2.9981, places=4, msg="Mid WATS aggregation failed")
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 3.0289, places=4, msg="Short TETS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 3.0241, places=4, msg="Mid TETS aggregation failed")
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 3.0363, places=4, msg="Short MOTS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 3.0293, places=4, msg="Mid MOTS aggregation failed")
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 3.0641, places=4, msg="Short EOTS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 3.0359, places=4, msg="Mid EOTS aggregation failed")
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 3.0363, places=4, msg="Short ECOTS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 3.0293, places=4, msg="Mid ECOTS aggregation failed")
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 3.0363, places=4, msg="Short AOTS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 3.0293, places=4, msg="Mid AOTS aggregation failed")
