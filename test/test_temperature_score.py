...
class TestTemperatureScore(unittest.TestCase):
    ...
    def test_portfolio_aggregations(self):
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 3.0357, places=4,
                               msg="Short WATS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 2.8163, places=4,
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 2.8828, places=4,
                               msg="Short TETS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 2.8998, places=4,
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 2.8844, places=4,
                               msg="Short MOTS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 2.8766, places=4,
        ...
        self.assertAlmostEqual(aggregations["short"]['s1s2']["all"]["score"], 2.9368, places=4,
                               msg="Short EOTS aggregation failed")
        self.assertAlmostEqual(aggregations["mid"]['s1s2']["all"]["score"], 2.8853, places=4,
