...
setup_kwargs = {
    ...
    "version": "1.2.5",
    "description": "This package implements Version 1.0 of the CDP/WWF Temperature Rating Methodology, helping companies and financial institutions to assess the temperature alignment of current targets, commitments, and investment and lending portfolios, and to use this information to develop targets for official validation by the SBTi.",
